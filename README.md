...
2. **Package for Intune/MECM:** Package TermServPlus.ps1 and the pre-configured TermServPlus.ini together as an .intunewin package.  
3. **Deploy:** Deploy the package to end-user machines (e.g., C:\\ProgramData\\TermServ+) and push a desktop shortcut targeting the script.  
...
2. Ensure execution policies allow running scripts (e.g., Set-ExecutionPolicy RemoteSigned \-Scope CurrentUser).  
